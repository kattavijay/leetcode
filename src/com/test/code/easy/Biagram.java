...
public class Biagram {
	...
	public static void main(String[] args) {
		...
		// String[] finalResult = findOcurrences("we will we will rock you",
		// "we","will");
		// String[] finalResult = findOcurrences("jxxxxxxxxxxxxxxxxxxxxxxxxxxxsxsh kypmsxd jkypmsxd kcyxdfnoa jkypmsxd
		// kcyxdfnoa jkypmsxd kcyxdfnoa kcyxdfnoa jkypmsxd
		// kcyxdfnoa","kcyxdfnoa","jkypmsxd");
		String[] finalResult = findOcurrences(
